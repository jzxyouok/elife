	...
	<div class="table_con">
		...
		<form action="" method="post">
			<table style="width: 60%;height:80%;margin: 0 auto;">
				...
				<tr>
					<td width="20%"  class="tdbg">商家账号：</td>
					<td width="18%" >lekebianli</td>
					<td width="19%"  class="tdbg">昵称：</td>
					<td width="18%" >乐可便利</td>
					<td width="25%" colspan="2"><img src="" width="74" height="74"/></td>
				</tr>
				<tr>
					<td width="12.5%"  class="tdbg">身份类型</td>
					<td width="12.5%">零食</td>
					<td width="12.5%"  class="tdbg">邮箱</td>
					<td width="12.5%">21</td>
					<td width="13%"  class="tdbg">注册时间</td>
					<td width="12%">这个字段在数据库中没有</td>
				</tr>
				<tr>
